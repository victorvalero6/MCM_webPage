...
// Dynamic import for react-leaflet components (they require window/document)
...
const Plantas = () => {
    ...
    const locations = [
        ...
        { name: "Lázaro Cárdenas, Michoacán", coords: [17.9595, -102.1986], type: "factory", color: "green" },
        ...
        { name: "Apodaca, Nuevo León", coords: [25.7833, -100.1833], type: "center", color: "orange" },
        ...
        <section id="plantas" className="bg-white">
            ...
            <div className="relative h-[400px] w-full overflow-hidden">
                ...
                <div className="absolute bottom-10 left-10 md:left-32">
                    <h2 className="text-3xl md:text-4xl text-white font-light border-l-4 border-green-500 pl-4">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
                ...
                <div className="text-center mb-16">
                    <h3 className="text-2xl md:text-3xl text-gray-800 font-light leading-relaxed max-w-4xl mx-auto">
                        {t.plants.introText}
                    </h3>
                </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                    ...
                    <div className="lg:order-2 space-y-4">
                        <div className="h-[500px] rounded-xl overflow-hidden shadow-lg border border-gray-200 z-0 relative bg-white">
                            {/* Map Container */}
                            {isClient && L && (
                                <MapContainer
                            ...
                            {!isClient && (
                                <div className="h-full w-full bg-gray-200 flex items-center justify-center">
                                    <span className="text-gray-500">{t.plants.mapLoading}</span>
                                </div>
                            )}
                        </div>
                        <div className="flex justify-end">
                            <button
                                ...
                                className="flex items-center space-x-2 bg-blue-900 hover:bg-blue-800 text-white px-4 py-2 rounded-lg shadow-md transition-colors text-sm font-medium"
                            >
                    ...
                    <div className="space-y-12 lg:order-1">
                        ...
                        {/* Productivas */}
                        <div className="relative pl-8 border-l-2 border-green-500 group">
                            <div className="absolute -left-3 top-0 bg-white p-1">
                                <Factory className="text-green-600" size={24} />
                            </div>
                            <h4 className="text-xl font-bold text-gray-900 mb-4 uppercase">{t.plants.productionTitle}</h4>
                            <ul className="space-y-2 text-gray-600 cursor-pointer">
                                <li className="hover:text-green-600 transition-colors">HERMOSILLO, SONORA</li>
                                <li className="hover:text-green-600 transition-colors">LÁZARO CÁRDENAS, MICHOACÁN</li>
                                <li className="hover:text-green-600 transition-colors">MONCLOVA, COAHUILA</li>
                                <li className="hover:text-green-600 transition-colors">SALTILLO, COAHUILA</li>
                            </ul>
                        </div>

                        {/* Distribución */}
                        <div className="relative pl-8 border-l-2 border-orange-500 group">
                            <div className="absolute -left-3 top-0 bg-white p-1">
                                <Truck className="text-orange-500" size={24} />
                            </div>
                            <h4 className="text-xl font-bold text-gray-900 mb-4 uppercase">{t.plants.distributionTitle}</h4>
                            <ul className="space-y-2 text-gray-600 cursor-pointer">
                                <li className="hover:text-orange-500 transition-colors">APODACA, NUEVO LEÓN</li>
                                <li className="hover:text-orange-500 transition-colors">PUEBLA, PUEBLA</li>
                            </ul>
                        </div>

                        {/* Almacenamiento */}
                        <div className="relative pl-8 border-l-2 border-blue-500 group">
                            <div className="absolute -left-3 top-0 bg-white p-1">
                                <Warehouse className="text-blue-500" size={24} />
                            </div>
                            <h4 className="text-xl font-bold text-gray-900 mb-4 uppercase">{t.plants.storageTitle}</h4>
                            <ul className="space-y-2 text-gray-600 cursor-pointer">
                                <li className="hover:text-blue-500 transition-colors">BROWNSVILLE, TEXAS</li>
                            </ul>
